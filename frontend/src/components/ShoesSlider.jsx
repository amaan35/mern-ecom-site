...
export default function ShoesSlider() {
  ...
  return (
    <div className="flex items-center">
      <span
        onClick={handlePrev}
        className="absolute left-2 rotate-180 bg-gray-400 rounded-full p-2 z-[1] cursor-pointer"
      >
      ...
      <span
        onClick={handleNext}
        className="absolute right-2 bg-gray-400 rounded-full p-2 z-[1] cursor-pointer"
      >
        <img src={rightarrow} width={25} />
      </span>
    </div>
